...
public class LTXmlUtils {
    ...
    public static File toSignXmlFile(Object obj, String fileName) throws LTParserException {
        ...
        try {
            ...
            throw new LTParserException(ex!=null?ex.getMessage():"未知错误");
        }
    }
}
